...
class ProductPage(BasePage):
    ...
    def should_be_success_message_present(self):
        ...
        product_name_in_success_message = self.get_text_from_element(*ProductPageLocators.PRODUCT_NAME_IN_SUCCESS_MESSAGE)
        ...
        assert product_name == product_name_in_success_message, "Product name in Message don`t equal product name on product page!"
